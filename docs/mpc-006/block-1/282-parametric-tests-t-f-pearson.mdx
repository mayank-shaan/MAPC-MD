...
$$t = \frac{M_1 - M_2}{\sqrt{\sigma_{M1}^2 + \sigma_{M2}^2 - 2r_{12}\sigma_{M1}\sigma_{M2}}}$$
...
$$SE_{DZ} = \sqrt{\frac{1}{N_1 - 3} + \frac{1}{N_2 - 3}}$$
...
*Previous ←* [Assumptions & Scales of Measurement](/mpc-006-statistics/block-1/assumptions-scales-measurement)  
*Next →* [Non-Parametric Tests: Chi-Square, Median, Mann-Whitney, Sign Test, Wilcoxon](/mpc-006-statistics/block-1/nonparametric-tests-chi-square-mann-whitney)
