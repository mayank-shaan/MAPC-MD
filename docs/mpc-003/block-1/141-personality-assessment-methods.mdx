...
```mermaid
quadrantChart
    title Personality Assessment Methods: Objectivity vs Depth
    x-axis Low Objectivity --> High Objectivity
    y-axis Shallow Depth --> Deep Depth
    quadrant-1 Objective but Shallow
    quadrant-2 Objective and Deep
    quadrant-3 Subjective and Shallow
    quadrant-4 Subjective but Deep
    Personality Inventories (MMPI): [0.85, 0.55]
    Behavioural Assessment: [0.75, 0.45]
    Structured Interview: [0.65, 0.6]
    Sentence Completion: [0.35, 0.65]
    TAT: [0.2, 0.8]
    Rorschach: [0.15, 0.85]
    Unstructured Interview: [0.3, 0.7]
```

| Method | Strengths | Limitations |
|--------|-----------|-------------|
| Interviews | Rich, flexible, rapport-building | Halo effect, interviewer bias, social desirability |
| Projective Tests | Access unconscious; rich qualitative data | Low reliability/validity; subjective scoring |
| Behavioural Assessment | Direct observation; no self-report bias | Observer bias; no environmental control |
| Personality Inventories | Standardised; objective; reliable/valid | Faking; response sets; social desirability |
