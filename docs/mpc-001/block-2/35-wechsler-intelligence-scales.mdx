...
- **Clinical pattern**: PRI lower than VCI may suggest nonverbal learning disability
...
**Formula concept:**
```
Deviation IQ = 100 + 15 × (Individual's Score - Age Group Mean) / Standard Deviation
```
...
**Interpretation:**
- **VCI lower than PRI**: 20-point discrepancy—verbal learning disability pattern
...
**Interpretation:**
- **FSIQ below 70**: Meets intellectual functioning criterion
...
- **PSI**: Average
- **Key discrepancy**: VCI significantly lower than PRI (≥12-15 points)
...
| **VCI-PRI** | Similar | VCI lower than PRI | VCI ≥ PRI |
...
**Mathematical basis:**
```
Deviation IQ = 100 + 15 × (Raw Score - Mean for Age) / SD for Age
```
